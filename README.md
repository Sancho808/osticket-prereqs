...
<br />                                                                                                                                                        
 ...
 ![image](https://github.com/user-attachments/assets/eeabdddb-110b-406c-a0a3-abfdc82b7b47                                                                                                                                                                                                                                          
  ...
  Now, create a Windows 10 Virtual Machine (VM), typically with 2-4 Virtual CPUs. For username and password, it can be anythingThen create a Virtual Machine in Microsoft Azure. Log into Azure. When you logged in, go to Virtual Machines->Create a Virtual Machine. Under size, you must make sure that your VM has AT LEAST 2 vCPU's. This will help with the overall speed of the VM.                                                                                                                                                                                                                                                                                                                                                     
