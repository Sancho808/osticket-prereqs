...
Create a Virtual Machine in Microsoft Azure. Log into Azure. When you logged in, go to Virtual Machines->Create a Virtual Machine. Under size, you must make sure that your VM has AT LEAST 2 vCPU's. This will help with the overall speed of the VM.                                                                                                                                                                                                                                          
